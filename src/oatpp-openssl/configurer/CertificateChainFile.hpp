...
#ifndef oatpp_openssl_configurer_CertificateChainFile_hpp
#define oatpp_openssl_configurer_CertificateChainFile_hpp
...
#endif // oatpp_openssl_configurer_CertificateChainFile_hpp
